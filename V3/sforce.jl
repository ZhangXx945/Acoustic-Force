...
# ╔═╡ 46053c4c-87fa-4054-ae51-ed1d9d826f1b
###########function to execute part of the parallel computation###############
...
# ╔═╡ 56a5eb59-135a-4166-9502-2c9da9b23930
###########function to execute part of the parallel computation###############
...
# ╔═╡ 7d510e23-5d91-41ac-a29c-2489fe606b23
###########function to execute part of the parallel computation###############
...
# ╔═╡ 58a59c48-7fad-4f41-81d4-9b098d89f090
###########function to execute part of the parallel computation###############
...
# ╔═╡ 4e1c63de-ef52-44a8-aad9-2d7934498792
###########function to execute part of the parallel computation###############
...
# ╔═╡ 2a758081-782e-4322-bbb0-fd7d102281b9
###########function to execute part of the parallel computation###############
...
# ╔═╡ 7e1ce8b8-ba7c-4a13-9246-f6920b6a1a7d
...
# ╔═╡ 77ad6596-5d05-4d2f-b981-5ce314b8519d
##################2-threaded routine#################################
################numerical quadrature for acoustic force################
#############n1,n2 denote sample numbers in polar angle θ and azimuthal angle ϕ coordinate respectively###############
...
# ╔═╡ 3cba4407-8df9-44a3-b75f-95611e16da73
##################4-threaded routine#################################
################numerical quadrature for acoustic force################
#############n1,n2 denote sample numbers in polar angle θ and azimuthal angle ϕ coordinate respectively###############
...
# ╔═╡ c3bb33ed-ae27-48f7-9d55-56066dea7315
##################6-threaded routine#################################
################numerical quadrature for acoustic force################
#############n1,n2 denote sample numbers in polar angle θ and azimuthal angle ϕ coordinate respectively###############
...
# ╔═╡ a4842b3d-c5c2-4a4e-b48c-5503f8bd8703
##################8-threaded routine#################################
################numerical quadrature for acoustic force################
#############n1,n2 denote sample numbers in polar angle θ and azimuthal angle ϕ coordinate respectively###############
...
# ╔═╡ daf84d73-d402-4bcd-8baa-970fa40e4951
